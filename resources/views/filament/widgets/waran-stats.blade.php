<x-filament-widgets::widget class="fi-wi-stats-overview col-span-full">
    <div class="sneat-stats-row">
        ...
        <div class="sneat-stat-card">
            <div class="sneat-stat-inner">
                <div>
                    ...
                    <h3 class="sneat-stat-value">{{ $totalWaran }}</h3>
                </div>
        ...
        {{-- Waran Tidak Seimbang --}}
        <div class="sneat-stat-card">
            <div class="sneat-stat-inner">
                <div>
                    <p class="sneat-stat-label">Waran Tidak Seimbang</p>
                    <h3 class="sneat-stat-value">{{ $tidakSeimbang }}</h3>
                    <p class="sneat-stat-desc sneat-stat-desc--danger">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                            <path fill-rule="evenodd" d="M10 3a.75.75 0 0 1 .75.75v10.638l3.96-4.158a.75.75 0 1 1 1.08 1.04l-5.25 5.5a.75.75 0 0 1-1.08 0l-5.25-5.5a.75.75 0 1 1 1.08-1.04l3.96 4.158V3.75A.75.75 0 0 1 10 3Z" clip-rule="evenodd" />
                        </svg>
                        {{ $tidakSeimbangPct }}% dari keseluruhan
                    </p>
                </div>
