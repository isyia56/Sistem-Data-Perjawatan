@extends('layouts.app')
@section('title', 'Edit PTJ')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h4 class="fw-bold mb-0">Edit PTJ</h4>
...
<form method="POST" action="{{ route('ptj.update', $ptj) }}">
    @csrf
    @method('PUT')
    <div class="card mb-4">
            ...
            <div class="row g-3">
                ...
                <div class="col-12">
                    ...
                    <input type="text" name="nama_ptj"
                        ...
                        value="{{ old('nama_ptj', $ptj->nama_ptj) }}">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="rujukan_surat"
                        ...
                        value="{{ old('rujukan_surat', $ptj->rujukan_surat) }}">
                ...
                <div class="col-12">
                    ...
                    <input type="text" name="pengarah"
                        ...
                        value="{{ old('pengarah', $ptj->pengarah) }}">
                ...
                <div class="col-12">
                    ...
                    <textarea name="alamat" rows="3"
                        class="form-control @error('alamat') is-invalid @enderror">{{ old('alamat', $ptj->alamat) }}</textarea>
                    @error('alamat')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>

                <div class="col-12">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="is_jkn" value="1" id="is_jkn"
                            {{ old('is_jkn', $ptj->is_jkn) ? 'checked' : '' }}>
